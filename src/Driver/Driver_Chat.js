import {
    ...
    StatusBar, TouchableOpacity, StyleSheet, Modal, ScrollView, Keyboard, KeyboardAvoidingView
} from 'react-native';
...
export default class Driver_Chat extends Component {
    constructor(props) {
        super(props)
        this.state = {
            name: '',
            ...
            <View style={{ flex: 1, backgroundColor: Colors.white1 }}>
                        ...
                        <View style={{ borderRadius: 20, position: 'absolute', bottom: 10, width: mobileW * 90 / 100, alignSelf: 'center', }}>
                            ...
                            <View style={{ width: mobileW * 90 / 100, alignSelf: 'center', borderRadius: 15, backgroundColor: 'white', paddingVertical: mobileW * 1 / 100 }}>
                                ...
                                <View style={{ justifyContent: 'center', paddingVertical: mobileW * 3 / 100 }}>
                                    <TouchableOpacity style={{ justifyContent: 'center', }} onPress={() => this.setState({ modalVisible: false },
                ...
                <View style={{ alignSelf: 'center', width: mobileW * 100 / 100, justifyContent: 'center', backgroundColor: Colors.theamColor, flexDirection: 'row', paddingVertical: mobileW * 2.5 / 100 }}>
                    ...
                    <View style={{ width: '70%', paddingLeft: mobileW * 3 / 100 }}>
                        ...
                        {/* <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ fontFamily: Font.Fontregular, color: Colors.textwhite, fontSize: mobileW * 2.5 / 100, textAlign: config.textalign }}>{Lang_chg.order_id[config.language]}: {config.language == 0 ? '#7856212356' : '7856212356#'}</Text>
                            </View> */}
                    </View>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    ...
                                    return (
                                        ...
                                        <View style={{ marginTop: 2, width: mobileW * 95 / 100, alignSelf: 'center' }}>
