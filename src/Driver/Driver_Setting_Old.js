import {
  Text, View, ImageBackground, Image, TextInput, Dimensions,  SafeAreaView, FlatList,
  StatusBar, TouchableOpacity, StyleSheet, ScrollView
} from 'react-native';
    ...
    return (
      <View style={{ flex: 1, backgroundColor:'#F7F7F7' }}>
        ...
        <View style={{
          ...
          <TouchableOpacity style={{ width: mobileW * 12 / 100, paddingLeft: mobileW * 3.7 / 100 }} onPress={() => this.props.navigation.goBack('')} >
        ...
        <ScrollView keyboardDismissMode='interactive' keyboardShouldPersistTaps='always' showsVerticalScrollIndicator={false}>
          <TouchableOpacity style={{ flex: 1, paddingBottom: mobileW * 30 / 100 }} activeOpacity={1}>
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => { this.props.navigation.navigate('Drivre_Edit_Profile', { 'Status': 2 }) }}
              style={{
                width: '96%', alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between',
                paddingVertical: mobileW * 0.035
              }}>
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => { this.props.navigation.navigate('Driver_Change_Password') }}
              style={{
                width: '96%', alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between',
                paddingVertical: mobileW * 0.035
              }}>
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() =>
                this.props.navigation.navigate('Driver_Contact_Us')
              }
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => { this.props.navigation.navigate('Drivre_Delete_Account') }}
              style={{
                width: '96%', alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between',
