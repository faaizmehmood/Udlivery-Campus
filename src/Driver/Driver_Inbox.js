...
class Driver_Inbox extends Component {
    constructor(props) {
        super(props)
        this.state = {
            user_id: 1,
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ paddingVertical: mobileH * 1 / 100, backgroundColor: Colors.theme_color }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: Colors.theme_color, paddingHorizontal: mobileW * 3 / 100 }}>
                        ...
                        <Text style={{ fontFamily: Font.FontMedium, fontSize: mobileW * 5 / 100, color: Colors.white_color }}>{Lang_chg.Inbox[config.language]}</Text>
                        <TouchableOpacity
                            activeOpacity={0.9}
                            style={{ width: mobileW * 10 / 100, alignItems: 'center', justifyContent: 'center', height: mobileW * 10 / 100, }}>
                ...
                <HideWithKeyboard>
                    <Driver_Footer
                        ...
                        footerpage={[
                            ...
                            { name: 'Driver_Inbox', fname: 'Chat', countshow: true, image: (localimag.Chatinactive), activeimage: (localimag.Chatactive) },
