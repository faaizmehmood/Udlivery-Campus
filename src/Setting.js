    ...
    apifuntion
      ...
      .then(obj => {
        ...
        if (obj.success == 'true') {
          ...
          // consolepro.consolelog('sharemsg', obj.content_arr[6].content)
          let sharemsg = obj.content_arr[6].content;

          // this.setState({ sharemsg: obj.content_arr[6].content })

          consolepro.consolelog('sharemsg', sharemsg);

          console.log('rateapp Url: ', rateappurl);

          this.setState({rateappurl: rateappurl, sharemsg: sharemsg});
        } else {
            ...
            <View
              ...
              <View style={{width: '15%', justifyContent: 'center'}}>
                <Switch
                  ...
                  // onValueChange={(text) => this.setState({ isSwitchOn: text })}
          ...
          <Footer
            ...
            footerpage={[
              ...
              },
              {
                ...
                activeimage: localimag.notifyinactive,
              },
              {
                name: 'Orderhistory',
                countshow: false,
